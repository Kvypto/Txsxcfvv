...
CreateButton("SilentAim", Combat1, function()
	local a=getrawmetatable(game)local b=a.__index;local c=loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Kvypto/Txsxcfvv/master/ararwq"))()c["TeamCheck"]=false;setreadonly(a,false)a.__index=newcclosure(function(d,e)if d:IsA("Mouse")and(e=="Hit"or e=="Target")then if c.checkSilentAim()then local f=rawget(c,"Selected")if f and f.Character and f.Character.FindFirstChild(f.Character,"Head")then return e=="Hit"and f.Character.Head.CFrame or f.Character.Head end end end;return b(d,e)end)setreadonly(a,true)
end);
...
CreateButton("WalkOnWalls", FunStuff1, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Kvypto/Txsxcfvv/master/Walk", true))()
end);
