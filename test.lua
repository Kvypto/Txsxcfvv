-- // STEFANUKS AIMING MODULE WE DID NOT MAKE THIS, THANKS.
...
-- // Load Silent Aim
local ValiantAimHacks = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Kvypto/Txsxcfvv/master/test.lua"))()
